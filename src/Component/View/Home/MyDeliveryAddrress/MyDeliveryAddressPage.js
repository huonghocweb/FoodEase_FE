...
const MyDeliveryAddressPage = () => {
  ...
  const handleDeliveryAddressForm = async (data) => {
    ...
    try {
      ...
      if (dataEdit) {
        resCreateDeliveryAddress = await axiosConfig.put(
          `/deliveryAddress/${dataEdit.deliveryAddressId}`,
          formData
        );
        ...
        resCreateDeliveryAddress = await axiosConfig.post(
          `/deliveryAddress`,
          formData
        );
        if (resCreateDeliveryAddress.data.data !== null) {
  ...
  const handleDeleteDeliveryAddress = async (deliveryAddressId) => {
    try {
      const resDeleteDeliveryAddressById = await axiosConfig.delete(
  ...
  const fetchDeliveryAddress = async () => {
    try {
      const resDeliveryAddressByUserName = await axiosConfig.get(
        `/deliveryAddress/getByUserName/${userName}`,
        {
          params: {
      ...
      handlePaginationChange(
        "totalPage",
        resDeliveryAddressByUserName.data.data.totalPages
      );
    } catch (error) {
  ...
  const fetchDeliveryAddressById = async (deliveryAddressId) => {
    ...
    try {
      const resDeliveryAddressById = await axiosConfig.get(
        `/deliveryAddress/getById/${deliveryAddressId}`
      );
  ...
  const handleGetDistrictByProvinceId = async (provinceId) => {
    ...
    try {
      const resDistrictsByProvince = await axiosConfig.post(
        `/ship/getDistrict/${provinceId}`
      );
  ...
  const handleGetWardByDistrictId = async (districtId) => {
    try {
      const resWardByDistrict = await axiosConfig.post(
        `/ship/getWard/${districtId}`
      );
