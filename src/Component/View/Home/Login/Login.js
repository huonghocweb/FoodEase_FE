      ...
      <div className="row">
        <div className="col-md-6 offset-md-3">
          <h2 className="text-center text-dark mt-5">
            {customTranslate("Login Form")}
          </h2>
          <div className="text-center mb-5 text-dark">
            {customTranslate("Delicious in every finger")}{" "}
          </div>
          <div className="login-card my-5">
            <form
              className="card-body login-cardbody-color p-lg-5"
            ...
            >
              ...
              <div className="mb-3">
                <input
                  ...
                  placeholder={customTranslate("UserName")}
                />
              </div>
              ...
              <div className="text-center">
                <button
                  type="submit"
                  className="btn login-btn-color px-5 mb-5 w-100"
                >
              ...
              <div>
                ...
                {customTranslate("Login by")} GOOGLE
                </button>
              </div>
