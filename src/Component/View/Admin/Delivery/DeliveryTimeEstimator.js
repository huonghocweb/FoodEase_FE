...
function DeliveryTimeEstimator() {
    ...
    return (
        <div className="delivery-estimator-container">
            ...
            />
            <button className="delivery-estimator-button" onClick={handleEstimate}>Estimate Delivery Time</button>
            {estimatedTime && <p className="delivery-estimator-estimated-time">Estimated Delivery Time: {estimatedTime} minutes</p>}
        </div>
    );
}
