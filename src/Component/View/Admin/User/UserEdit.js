...
const UserEdit = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const roleIdsToSend =
      formData.roleIds.length > 0 ? formData.roleIds : initialRoleIds;
    ...
    const filteredRoleIds = formData.roleIds.filter(
  ...
  return (
    <div className="user-form-container">
      <h2 className="user-form-title">{customTranslate("Edit User")}</h2>
