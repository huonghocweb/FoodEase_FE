...
const UserOrder = () => {
  ...
  const featchUserOrder = async () => {
    await axiosConfig
      .get(`/order/ReportUserBuy?date=${date}&page${page}`)
      .then((response) => {
    ...
    <div>
      <div className="revenue-container2">
        <div className="orderlist-find">
          ...
          <button onClick={exportExcel}>{customTranslate("Export")}</button>
        </div>
        <table className="revenue-table2">
          <thead className="user-order">
            <tr>
              <th className="revenue-th2">{customTranslate("Order No.")}</th>
              <th className="revenue-th2">{customTranslate("Order date")}</th>
              <th className="revenue-th2">{customTranslate("Full Name")}</th>
              <th className="revenue-th2">{customTranslate("Gender")}</th>
              <th className="revenue-th2">{customTranslate("Phone number")}</th>
              <th className="revenue-th2">{customTranslate("Email")}</th>
              <th className="revenue-th2">{customTranslate("Birthday")}</th>
              <th className="revenue-th2">{customTranslate("Address")}</th>
              <th className="revenue-th2">
                {customTranslate("Total Quantity")}
              </th>
              <th className="revenue-th2">{customTranslate("Total Price")}</th>
            </tr>
          </thead>
          <tbody>
